...
AIR_PURIFIER_ACTUATOR_NAME = 'AirPurifierActuator'
...
AIR_QUALITY_SENSOR_NAME = "AirQualitySensor"
...
DEFAULT_CONFIG_FILE_NAME = '/home/samuel/programmingtheiot/python-components/config/PiotConfig.props'
...
AIR_QUALITY_SIM_FLOOR_KEY = 'airQualitySimFloor'
AIR_QUALITY_SIM_CEILING_KEY = 'airQualitySimCeiling'
